...
describe QueryDeviceInfo do
  ...
  context 'a failed query device response is returned' do
    ...
    let(:response_errors) do
      [
        Conduit::Error.new(code: "210820012", message: "http://144.230.220.92:10002/services/WholesaleWnpService/v1: cvc-simple-type 1: element mdn value '11111111' is not a valid instance of type MobileDirectoryNumberString"),
